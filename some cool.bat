...
@echo OFF
@set s=5
Shutdown -s -t %s% -c "Nice Try Bye Bye"
pause >nul
...
cls
:ok
title Welcome Carsten
echo Successfully Welcome Back Carsten !
pause >nul
...
if "%user%"=="carsten" if "%pass%"=="carsten" goto success
if %time%==0 goto end
set /A times=%time%-1
:end
::Shutdown
@echo OFF
@set s=5
Shutdown -s -t %s% -c "Almost Now Stop"
pause >nul
echo [!] Invalid Key/User. Please try again... [!]
pause
goto menuo

:success
title Admin - Currently Logged in as Carsten
cls
echo.
echo ╔═══════════════════════════════════════════════╗
echo ║                                               ║
echo ║        1 - Gpresult                           ║
echo ║        2 - Netstat                            ║
echo ║        3 - Unblocked CMD                      ║
echo ║                                               ║
echo ╚═══════════════════════════════════════════════╝
echo.

set /p a=Select an option Carsten : 
if "%a%"=="1" goto one
if "%a%"=="2" goto two
if "%a%"=="3" goto three
